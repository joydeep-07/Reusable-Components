...

{
  ...
  <div className="relative z-10 flex items-end gap-6">
    <h1 className="text-7xl md:text-8xl leading-[1.4] font-semibold text-neutral-700">
      Hey,
    </h1>
    <RotatingText
      texts={[
      ...
      mainClassName="text-7xl md:text-8xl leading-[1.4] font-semibold text-amber-700"
      staggerFrom="last"
      initial={{ y: "100%" }}
      animate={{ y: 0 }}
      exit={{ y: "-120%" }}
